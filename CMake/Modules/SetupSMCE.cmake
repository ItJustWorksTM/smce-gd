...
set (SMCE_EXPECTED_TAG ignore)
set (SMCE_EXPECTED_VERSION 0.0.0)
...
if (NOT WIN32 AND NOT APPLE)
    if (EXISTS "${SMCE_ROOT}/lib64/boost/${CMAKE_STATIC_LIBRARY_PREFIX}boost_filesystem${CMAKE_STATIC_LIBRARY_SUFFIX}")
        ...
        set_property (TARGET WA_BoostFS PROPERTY IMPORTED_LOCATION "${SMCE_ROOT}/lib64/boost/${CMAKE_STATIC_LIBRARY_PREFIX}boost_filesystem${CMAKE_STATIC_LIBRARY_SUFFIX}")
        target_link_libraries (SMCE INTERFACE WA_BoostFS)
    endif ()
endif ()
