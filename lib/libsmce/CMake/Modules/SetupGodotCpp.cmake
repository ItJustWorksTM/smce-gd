...
if(NOT GDCPP_ROOT OR NOT EXISTS GDCPP_ROOT)
    ...
    FetchContent_Declare (fc-godot-cpp
            ...
            GIT_TAG        5eb1c54116a135ac3d7f80b50cbe3cbe137318c6
    )
    ...
    if (NOT EXISTS "${GDCPP_SOURCES_MOD}")
        ...
        execute_process (COMMAND "python" "-c" "import binding_generator_ext; binding_generator_ext.generate_bindings(\"godot-headers/extension_api.json\", [${GDCPP_NEEDED_CLASSES_FMTD}], False)"
...
if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
	target_compile_definitions(godot-cpp PUBLIC TYPED_METHOD_BIND)
endif()