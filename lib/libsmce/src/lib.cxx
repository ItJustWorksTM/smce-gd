...
GDNativeBool GDN_EXPORT example_library_init(const GDNativeInterface* p_interface,
    ...
    init_obj.register_scene_initializer(
        register_types<Result, BoardDeviceSpecification, PluginManifest, Sketch, SketchConfig, BoardConfig,
                       BoardConfig::BoardDeviceConfig, BoardConfig::GpioDriverConfig,
                       BoardConfig::FrameBufferConfig, BoardConfig::SecureDigitalStorageConfig,
                       BoardConfig::UartChannelConfig, Toolchain, ToolchainLogReader, ManifestRegistry, Board,
                       BoardLogReader, BoardView, GpioPin, FrameBuffer, UartChannel>);
