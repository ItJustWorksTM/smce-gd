...
<package xmlns="http://schemas.microsoft.com/packaging/2011/08/nuspec.xsd">
  <metadata>
    ...
    <description>Boost provides free portable peer-reviewed C++ libraries. The emphasis is on portable libraries which work well with the C++ Standard Library. This package includes Boost headers and libs compiled with Visual Studio for 64bit Windows.</description>
    <summary>Boost headers and libs compiled with Visual Studio 2019 for 64bit Windows.</summary>
...
if (-not (Test-Path "`$installDirRoot\lib64*")) { rm -Recurse -Force "`$installDirRoot" }
"@
